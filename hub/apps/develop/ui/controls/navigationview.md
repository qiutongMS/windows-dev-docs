...
For other navigation patterns, see [Navigation design basics](../../../design/basics/navigation-basics.md).
...
For more information about window sizes for adaptive behavior, see [Screen sizes and breakpoints](../../../design/layout/screen-sizes-and-breakpoints-for-responsive-design.md).
