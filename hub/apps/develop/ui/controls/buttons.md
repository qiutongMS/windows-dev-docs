...
-  If the button's text content is dynamic (that is, it is [localized](../../../design/globalizing/globalizing-portal.md)), consider how the button will be resized and what will happen to controls around it.
