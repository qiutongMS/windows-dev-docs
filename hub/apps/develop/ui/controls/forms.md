...
### Responsive layout
Forms should resize as the screen or window size changes, so users don't overlook any input fields. For more information, see [responsive design techniques](../../../design/layout/responsive-design.md). For example, you might want to keep specific regions of the form always in view, no matter the screen size.
...
```xaml
<Grid>
    <Pivot Background="{ThemeResource AcrylicInAppFillColorDefaultBrush}" >
        <Pivot.TitleTemplate>
            <DataTemplate>
                <Grid>
