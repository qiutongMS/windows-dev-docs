...
By default, content dialogs display modally relative to the root XAML content. When you use ContentDialog inside of either an [AppWindow](/windows/windows-app-sdk/api/winrt/microsoft.ui.windowing.appwindow) or a [XAML Island](../../../../desktop/modernize/xaml-islands/xaml-islands.md), you need to manually set the [XamlRoot](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.uielement.xamlroot) on the dialog to the root of the XAML host.
