...
You typically use an indirect targeting technique to apply animations to the properties of a transform. For more info about indirect targeting syntax, see [Storyboarded animations](../../../design/motion/storyboarded-animations.md) and [Property-path syntax](property-path-syntax.md).
