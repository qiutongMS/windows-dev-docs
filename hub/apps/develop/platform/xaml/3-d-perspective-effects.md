...
description: You can apply 3-D effects to content in your WinUI 3 apps using perspective transforms. For example, you can create the illusion that an object is rotated toward or away from you, as shown here.
ms.date: 02/08/2017
ms.topic: article
...
You can apply 3-D effects to content in your WinUI 3 apps using perspective transforms. For example, you can create the illusion that an object is rotated toward or away from you, as shown here.
