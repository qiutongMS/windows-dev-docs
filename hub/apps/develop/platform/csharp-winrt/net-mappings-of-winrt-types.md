...
The C#/WinRT custom type mappings are categorized by types in the Windows SDK or in [WinUI 3](../../../winui/index.md) (WinUI is part of the [Windows App SDK](../../../windows-app-sdk/index.md)). The WinRT types for Windows SDK mappings live under the **Windows.\*** namespaces, and the WinRT types for WinUI mappings live under the **Microsoft.UI.Xaml.\*** namespaces. There are two reasons for custom type mappings that C#/WinRT makes for WinRT types:
