...
> **Important APIs**:  [**Windows.Devices.Input**](/uwp/api/Windows.Devices.Input), [**Windows.UI.Input**](/windows/windows-app-sdk/api/winrt/microsoft.ui.input), [**Windows.UI.Core**](/windows/windows-app-sdk/api/winrt/microsoft.ui.input)
>
> [!NOTE]
