...
See [Keyboard accessibility](../../design/accessibility/keyboard-accessibility.md) for more details about customizing tab stops.
...
The **F6** key lets a user cycle between panes or important sections of your app or UI. **Shift-F6** typically cycles backwards (see [Keyboard accessibility](../../design/accessibility/keyboard-accessibility.md)).

These are often related to [landmarks and headings](../../design/accessibility/landmarks-and-headings.md), but do not need to correspond directly.
